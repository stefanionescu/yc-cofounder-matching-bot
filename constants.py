...
PROMPT_ENDING = "Your answer must be formatted exactly like this: {'output': 'Pass'} or {'output': 'Fail'}. You say {'output': 'Pass'} if the answers for all of the questions I asked are Yes. You say {'output': 'Fail'} if the answer for at least one of the questions I asked is No."
...
SHORT_MAX_SECONDS_TO_WAIT = 8
NORMAL_MIN_SECONDS_TO_WAIT = 12
NORMAL_MAX_SECONDS_TO_WAIT = 17
LONG_MIN_SECONDS_TO_WAIT = 22
LONG_MAX_SECONDS_TO_WAIT = 27
